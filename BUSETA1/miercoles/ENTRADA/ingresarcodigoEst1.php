...
try {
	...
	if ($resultado !== false) {
		...
		$consulta = "UPDATE buseta1 Set miercoles_entrada = NOW() WHERE id = '$codigoEstudiante' ";
		...
		$errores = '<li>ID incorrecto o no perteneces a este grupo de la buseta</li> <script> window.alert("INGRESE EL CÓDIGO CORRECTAMENTE"); </script>';
	}
}

// Hacemos una referencia con el archivo login.view.php
require 'ingresarcodigoEst1.view.php';
