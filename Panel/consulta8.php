...
<html lang="en" dir="ltr">
  ...
  <body>
    <main class="container">
      <form method="POST">
        <div class="form-group">
          <label class="titulo2">Ingrese el número de cédula del Estudiante a buscar</label>
          <br>
          <a href="panel.php" class="btn btn-primary btn-lg">Volver al Panel de Control</a>
          <br>
          <br>
          <input type="text" name="ced" class="form-control" placeholder="Ingrese el numero de cedula">
          <br>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $resultados = mysqli_query($conexion, "SELECT * FROM buseta8 WHERE cedula = '$buscarCed'");
