...
<body>
    <main class="container-fluid">
        ...
        <h2 class="titulo2">Buseta #5</h2>
        <a href="panel.php" class="btn btn-primary btn-lg">Volver al Panel de Control</a> <a href="reporteEntrada5.php" class="btn btn-success btn-lg">Generar Reporte 7:00AM</a>
        <a href="reporteSalida5.php" class="btn btn-success btn-lg">Generar Reporte 4:20PM</a>
        <br>
        <br>
