...
function Header()
{
    ...
    $this->Cell(140);
    // Título
    $this->Cell(70,10,'Reporte De Estudiantes, Buseta#8',0,0,'C');
    $this->Ln(15);
    $this->Cell(130);
...
while ($row = $result->fetch_assoc()) {
  ...
  $pdf->Cell(28, 10, $row['lunes7'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['lunes4'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['martes7'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['martes4'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['miercoles7'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['miercoles4'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['jueves7'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['jueves4'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['viernes7'], 1, 0, 'C', 0);
  $pdf->Cell(28, 10, $row['viernes4'], 1, 1, 'C', 0);
}
