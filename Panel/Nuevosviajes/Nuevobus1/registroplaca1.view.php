...
<body>
  <div class="contenedor">
    <h1 class="titulo">Nuevo viaje #1</h1>
    <hr class="border">

  <form class="formulario" name="login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">

    <div class="form-group">
      <i class="icono izquierda fa fa-user"></i><input class="usuario" type="text" name="nombre" placeholder="Nombre del Estudiante">
    </div>
    ...
    <div class="form-group">
      <i class="icono izquierda fa fa-circle"></i><input class="usuario" type="text" name="seccion" placeholder="seccion">
    </div>
